...
import NavbarOnly from "@/components/common/NavbarOnly";
...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Navbar Only - No Hero Content */}
      <NavbarOnly />

      {/* Main Content */}
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 py-12 mt-20">
      <div className="w-full max-w-lg">
        {/* Logo/Brand Section */}
        <div className="mb-10 text-center">
          <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-green-600 to-green-400 shadow-2xl shadow-green-500/20 ring-4 ring-green-100">
        ...
        <Card className="border-slate-200 shadow-2xl backdrop-blur-sm bg-white/95">
          ...
          <CardContent className="px-8 pb-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 shadow-lg shadow-green-500/30 transition-all duration-200 hover:shadow-xl hover:shadow-green-500/40 mt-6"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
