              ...
              {isLoading ? (
                ...
                filteredEvents.map((event) => (
                  <TableRow key={event.id}>
                    ...
                    <TableCell>{event.isHybrid ? 'Hybrid' : event.isVirtual ? 'Virtual' : 'In-Person'}</TableCell>
                    <TableCell>
                      <div className="text-sm">
                        <p>{event.registeredAttendees?.length || 0} registered</p>
                        <p className="text-xs text-muted-foreground">Capacity: {event.capacity || 'N/A'}</p>
                      </div>
                    </TableCell>
