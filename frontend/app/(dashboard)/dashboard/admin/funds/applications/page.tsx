...
export default function AdminFundApplicationsPage() {
  ...
  const allApplications = funds
    ...
    .filter(app => {
      ...
      const searchMatch = searchTerm === '' || 
        ...
        app.fundTitle.toLowerCase().includes(searchTerm.toLowerCase());
      return statusMatch && fundMatch && searchMatch;
    });
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Review and manage all fund applications</p>
      </div>
